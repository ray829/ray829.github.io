    ...
    <div class="content">
        <div class="container">
            <svg id="bongo-cat" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 787.3 433.8">
                ...
                <g id="head">
                    <g id="head__outline">
                    <path d="M303.2,186.3c4-7,14.8-20.2,20-26,17-19,34.6-34.9,43-41l12-8s16.6-32,21-33c9-2,33,22,33,22s20-9,79,7c41,11.1,47,14,57,22,7.5,6,18,16,18,16s33.7-19.5,41-15-2,66-2,66,5.9,12.9,11,22c9.1,16.2,13.6,20.2,19,31,3.6,7.2,8.4,28.5,10.5,43.5l-385-62Z" fill="rgba(255, 255, 255, .8)"></path>
                    ...
                    <g id="mouth">
                        <path d="M399.2,186.3c.9,3.6,2.6,7.8,6,9,6.4,2.3,19-6,19-6s4.1,12.4,10,15,10.7-1.7,16-6" fill="rgba(255, 255, 255, .8)"></path>
                ...
                <g id="table">
                    <path d="M65.7,181.8l714,124c0,74-2,54-2,128l-673-161Z" fill="rgba(255, 255, 255, .5)"></path>
                ...
                <g id="laptop">
                    <g id="laptop__base">
                    <polygon points="641.9 304.1 454.7 348.2 103.8 271.3 254.6 230.3 641.9 304.1" fill="rgba(242, 242, 242, .5)"></polygon>
                    ...
                    <g id="paw-right">
                    <g id="paw-right--down">
                        <path d="M293.2,191.3l10-7s-18.4,11.1-24,20-13,20.4-9,31c4.7,12.4,20.5,15.7,22,16,20,3.8,47.8-24.3,47.8-24.3s1.9-3.3,2.2-3.7" fill="rgba(255, 255, 255, .5)"></path>
                    ...
                    <g id="paw-right--up">
                        <g>
                        <path d="M282.2,215.2c-1.6-1.6-12.8-17.9-14-34.3-.1-2.5,1.7-16,12.9-22.4s22.3-1.9,26.2.4c12.2,7.3,21.2,19.1,22.8,22.4" fill="rgba(255, 255, 255, .5)"></path>
                    ...
                    <g id="laptop__code">
                        <g stroke="rgba(61, 224, 232)" stroke-width="6" transform="matrix(-1 0 0 1 278 103)">
                    ...
                    <polygon points="440.7 347.2 90.3 275.6 4.7 3.8 353 36.7 440.7 347.2" fill="rgba(242, 242, 242, .5)"></polygon>
                ...
                <g id="paw-left">
                    <g id="paw-left--up">
                    <g>
                        <path d="M545.4,261.9c-7.1-13-12.9-31.1-13.3-37.6-.6-9,0-15.6,5.2-22.2s15-9.8,22.7-8.8a26.7,26.7,0,0,1,17.3,9.4c5.3,5.8,9.4,12.9,11.6,16.6" fill="rgba(255, 255, 255, .5)"></path>
                    ...
                    <g id="paw-left--down">
                    <path d="M538.2,239.3c-3.2,1.6-33,10.8-37,28-.4,1.8-2.1,18.9,7,26,5.5,4.3,12.7,2.8,25,0,10.3-2.3,19-5.8,40-16,9.1-4.4,16.6-8.2,22-11" fill="rgba(255, 255, 255, .5)"></path>
